...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
		...
		model.add(modelFactory.createStandaloneElementTag("div", "th:replace", "fragments/MensagemSucesso :: mensagemSucesso"));
		model.add(modelFactory.createStandaloneElementTag("div", "th:replace", "fragments/MensagensErroValidacao :: mensagemErro"));
